...
const Feed = () => {
  ...
  let feedList = (value) => {
    setFeed((prevState) => [value, ...prevState]);
  };
  let modalDisabler = () => {
    setModal(false);
  };
  ...
  return (
    <div className="Feed">
      <div className="Post-Container">
        <div className="Post-Container-Search-Bar-Container">
          <div className="Post-Container-Search-Bar-Container-Image-Container">
            <img src={ProfilePic} width="100%" />
          </div>
          <div
            className="Post-Container-Search-Bar-Container-Input"
        ...
        {modal && ( //!Modal
          <div className="Post-Composer-Modal-Container">
            <div className="Post-Composer-Modal-Container-Inside">
              <PostComposer
                feed={feed}
                feedList={feedList}
                modal={modalDisabler}
        ...
        <div className="Post-Container-Button-Container">
          <span>
            <div>
      ...
      {feed.map((value, key) => (
        <Post text={value.postcontent} gif={value.gif} key={key} />
      ))}
    </div>
  );
};
